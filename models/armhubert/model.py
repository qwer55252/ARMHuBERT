...
from .reusing_module import TransformerEncoderWithReuse
...
class CustomStudentModelConfig(FairseqDataclass):
    ...
    reuse_pattern: str = field(
        ...
        metadata={"help": "Development functionality"
                          "Reuse pattern of attention map"}
    )
...
class CustomStudentModel(BaseFairseqModel):
    def __init__(
        ...
        **kwargs,
        ...
        encoder_cls = TransformerEncoderWithReuse
